...
/**
 * Enable detection of DDD application services.
 * <p>
 * Each class annotated with {@link ApplicationService @ApplicationService} will be automatically added as a bean to the
 * application context.
 */
@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Import(EnableApplicationServices.Registrar.class)
public @interface EnableApplicationServices {
     ...
     * {@code @EnableApplicationServices("org.my.pkg")} instead of
     * {@code @EnableApplicationServices(basePackages = "org.my.pkg")}.
     */
    @AliasFor(attribute = "basePackages")
    String[] value() default {};

    /**
     * Base packages to scan for {@link ApplicationService Application Services}.
     * <p>
     ...
     * {@link ApplicationService Application Services}. The package of each class specified will be scanned.
     * <p>
    ...
    class Registrar implements ImportBeanDefinitionRegistrar, EnvironmentAware {
        ...
        public void registerBeanDefinitions(final AnnotationMetadata metadata, final BeanDefinitionRegistry registry) {
            ServiceImportRegistrarUtil.registerBeanDefinitions(
                    ...
                    registry,
                    environment,
                    EnableApplicationServices.class,
                    Collections.singleton(ApplicationService.class));
        }
    }
}
